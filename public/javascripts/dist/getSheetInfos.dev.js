...
function getSheetInfos() {
  var idSpreadsheetData, categoryRange, parametersRange, resultsRange, getCategoryInfo, copyCategoryInfo, formatNumber, getParametersInfo, getUrl, auth, sheets;
  return regeneratorRuntime.async(function getSheetInfos$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          getUrl = function _ref5(parameters) {
          ...
          getParametersInfo = function _ref4(data) {
            var parameters = {};
            var isPercent = 0;
          ...
          formatNumber = function _ref3(dat, isPercent) {
          ...
          copyCategoryInfo = function _ref2(catName, categoriesInfo) {
            var catFinal = {};
          ...
          getCategoryInfo = function _ref(data) {
            var category = {};
            var cat = {
              index: data[0],
              name: data[2],
          ...
          idSpreadsheetData = "1bs5NC1uJkO-X-n4N0LFAHgGgAUGuc0uu1C2WmqdkN58";
          categoryRange = 'Secteurs!A3:I7';
          parametersRange = 'Paramètres!A3:V26';
          resultsRange = 'Résultats!A1:BB300';
